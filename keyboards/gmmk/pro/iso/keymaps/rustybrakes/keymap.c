...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN1] = LAYOUT(
        ...
        _______, _______, RGB_VAI, _______, _______, _______, _______, _______, KC_SLCK, KC_PAUS, _______, _______, _______,                   KC_HOME,
        _______, _______, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_END,
